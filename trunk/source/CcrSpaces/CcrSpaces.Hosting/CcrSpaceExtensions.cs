...
namespace CcrSpaces.Hosting
{
    public static class CcrSpaceExtensions
    {
        ...
        public static void HostPort<TInput, TOutput>(this ICcrSpace space, PortSet<TInput, CcrsRequest<TInput, TOutput>, CcrsRequestOfUnknownType> ports, string name) { space.Resolve<CcrsHost>().HostPort(ports, name); }
        ...
        public static PortSet<TInput, CcrsRequest<TInput, TOutput>, CcrsRequestOfUnknownType> ConnectToPort<TInput, TOutput>(this ICcrSpace space, string remoteAddress) { return space.Resolve<CcrsHost>().ConnectToPort<TInput, TOutput>(remoteAddress); }
