...
namespace CcrSpaces.Hosting
{
    public static class CcrsHostExtensions
    {
        ...
        public static PortSet<TInput, CcrsRequest<TInput, TOutput>> ConnectToPort<TInput, TOutput>(this ICcrSpace space, string remoteAddress) { return space.Resolve<CcrsHost>().ConnectToPort<TInput, TOutput>(remoteAddress); }
